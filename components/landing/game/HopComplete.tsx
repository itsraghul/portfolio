...
import { PLATFORM_CONFIGS } from "@/constants/game";
import type { GameMode } from "@/types/game";

interface HopCompleteProps {
  isGameOver: boolean;
  isComplete: boolean;
  score: number;
...
export default function HopComplete({
  isGameOver,
  isComplete,
  score,
  highestPlatformIdx,
  ...
  const totalPlatforms = PLATFORM_CONFIGS.length;
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold font-mono mb-2">
              {isComplete ? "You Made It!" : "Game Over"}
            </h2>
            <p className="text-sm text-muted-foreground mb-6">
              {isComplete
                ? "You hopped to the top of my portfolio!"
                : "You fell off! Try again?"}
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <div className="flex flex-col items-center">
                <span className="text-2xl font-bold font-mono text-primary">
                  {highestPlatformIdx + 1}/{totalPlatforms}
                </span>
